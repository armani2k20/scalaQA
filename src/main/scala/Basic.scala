...
object Basic {
  def main(args: Array[String]) {
    ...
    def string1(message: String, n: Int): String = message.substring(message.length - n)

    println(string1("Hello", 3))
    ...
    def string2(msg1: String, msg2: String, m1: Char, m2: Char): String = msg1.concat(msg2).replace(m1, m2)
    ...
    def message7(n1: Int, n2: Int, q: Boolean): Int = {
